export function Header({ darkMode, toggleDarkMode }) {
  return (
    <header className='flex justify-between items-center mb-9'>
      <h1 className='text-textColorTwo text-3xl leading-9'>devfinder</h1>
      <button
        className='text-xs font-bold tracking-widest text-textColorOne cursor-pointer border-none bg-transparent uppercase flex items-center gap-4 transition duration-300 ease-in-out hover:scale-125 hover:text-themeToggleHoverColor
        fill-white hover:fill-themeToggleHoverColor'
